...
public class DirectionChangeTest {
    ...
    public void playersChangeDirectionTest() throws IOException, URISyntaxException {
        ...
        String fileName = getClass().getResource("/stage6files/direction_changes_players_positions.txt").toURI().getPath().substring(1);
    ...
    public void stuckOnWallTest() throws IOException, URISyntaxException {
        ...
        String fileName = getClass().getResource("/stage6files/stuckonwall_positions.txt").toURI().getPath().substring(1);
		Stream<String> player_positions = Files.lines(Paths.get(fileName));
    	Iterator<String> pos_iterator = player_positions.iterator();
    ...
    public void stuckOnBombTest() throws IOException, URISyntaxException {
        ...
        String fileName = getClass().getResource("/stage6files/stuckonbomb_positions.txt").toURI().getPath().substring(1);
		Stream<String> player_positions = Files.lines(Paths.get(fileName));
    	Iterator<String> pos_iterator = player_positions.iterator();
    ...
    public void stuckOnCrumblingWallTest() throws IOException, URISyntaxException {
        ...
        String fileName = getClass().getResource("/stage6files/stuckoncrumblingwall_positions.txt").toURI().getPath().substring(1);
		Stream<String> player_positions = Files.lines(Paths.get(fileName));
    	Iterator<String> pos_iterator = player_positions.iterator();
    ...
    public void playerStopsNextCentralTest() throws IOException, URISyntaxException {
        ...
        String fileName = getClass().getResource("/stage6files/playerstopsnextcentral_positions.txt").toURI().getPath().substring(1);
		Stream<String> player_positions = Files.lines(Paths.get(fileName));
    	Iterator<String> pos_iterator = player_positions.iterator();
    ...
    public void playerLeavesBombedCellTest() throws IOException, URISyntaxException {
        ...
        String fileName = getClass().getResource("/stage6files/playerleavesbombedcell_positions.txt").toURI().getPath().substring(1);
		Stream<String> player_positions = Files.lines(Paths.get(fileName));
    	Iterator<String> pos_iterator = player_positions.iterator();
