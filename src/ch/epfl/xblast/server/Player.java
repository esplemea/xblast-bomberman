...
public class Player {
    ...
    /**
     * Constructor for a Player using a integer for the lives and a Cell for the
     * positions
     * 
     * @param id
     * @param lives
    ...
    /**
     * Create a Sequence according to the number of lives left of the
     * player
     * 
     * @param lives
     * @return
    ...
    private static Sq<LifeState> createLifeState(int lives) {
        if (lives > 0) {
            return Sq
                    ...
                    .concat(Sq
                            .constant(new LifeState(lives, State.VULNERABLE)));
        } else {
    ...
    public Sq<LifeState> statesForNextLife() {
        Sq<LifeState> lives = Sq.repeat(Ticks.PLAYER_DYING_TICKS,
                new LifeState(lives()-1, State.DYING));
        return lives.concat(createLifeState(lives()-1));
    }
    ...
    public static final class DirectedPosition {
         ...
         * @return a infinite Sequence of DirectedPosition p
         */
         ...
         * @param p
         *            the DirectedPosition
         * @return a infinite Sequence of DirectedPosition in the direction of p
         *         and each the neighbor of the last one in the same direction
         *         of p
         */
        public static Sq<DirectedPosition> moving(DirectedPosition p) {
            return Sq
                    .iterate(p,
                            c -> new DirectedPosition(
                                    c.position.neighbor(c.direction),
                                    c.direction));
        }
