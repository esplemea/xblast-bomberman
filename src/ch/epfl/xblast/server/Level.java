...
public final class Level {
    ...
    private static Level defaultLevel() {
        ...
        Board defaultBoard = Board.ofQuadrantNWBlocksWalled(defaultInnerBlocks);

        List<Player> defaultPlayers = new ArrayList<>();
        defaultPlayers
                .add(new Player(PlayerID.PLAYER_1, 3, new Cell(1, 1), 2, 3));
        defaultPlayers
                .add(new Player(PlayerID.PLAYER_2, 3, new Cell(13, 1), 2, 3));
        defaultPlayers
                .add(new Player(PlayerID.PLAYER_3, 3, new Cell(13, 11), 2, 3));
        defaultPlayers
                .add(new Player(PlayerID.PLAYER_4, 3, new Cell(1, 11), 2, 3));

        BoardPainter defaultBoardPainter = new BoardPainter(defaultPalette,
